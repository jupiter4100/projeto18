...
function criarDiamantes() {
  ...
  var diamantes = createSprite(Math.round(random(50,width-350),40, 10, 10));
...
function criarJoias() {
  ...
  var joias = createSprite(Math.round(random(50,width- 350),40, 10, 10));
...
function criarEspadas(){
  ...
  var espada = createSprite(Math.round(random(50,width- 350),40, 10, 10));
